...
// Mandatory header for pop up 1 
  const headerElement = (
    <div className="header-dialog">Refer </div>
  );

// Mandatory footer for pop up 1, just a placeholder so that it works but its opacity is turned down
const footerContent = (
...
// close function popup1 = "Refer again"
const closepopup = () => {setVisible(false)} 

// close function popup2 = "Spin button"
const closepopup2 = () => {setVisible2(false)} 

// Mandatory header for pop up 2
const header2Element = (
  <div className="header-dialog2">Your reward:</div>
);


// Mandatory footer for pop up 2, just a placeholder so that it works but its opacity is turned down
const footer2Content = (
  ...
  return (
    ...
    <div className="users-main-page-v5">
      ...
      {/* Tier 1 title + current tier progress */}
      ...
      {/* first reward from tier 1: Spiderman poster */}
      <img
      ...
      {/* second reward from tier 1: Spiderman comic */}
      <img
      ...
      {/* White check icon that appears when you redeem a reward */}
      <img
      ...
      {/* Dropping tier counter from top right screen */}
      ...
      {/* first reward from tier 3: Udemy course */}
      <img
      ...
      {/* second reward from tier 3: bungee jumping */}
      <img
      ...
      {/* Secon reward from tier 4: Vintage machine */}
      <img
      ...
      {/* Text that appears when hovering over the atomic habits book */}
      ...
      {/* Lock icons for rewards that are still not available */}
      <img
      ...
      <div className="component-3">
        ...
        {/* first reward from tier 2: Atomic habits book + Hover function call */}
        <img
        ...
        {/* second reward from tier 2: gift cards + Hover function call */}
        <img
      ...
      {/* Season title and current season */}
      <div className="season-switch-autumn">
        ...
        {visible && <div className="card flex justify-content-center "  >
           ...
           <Dialog visible={visible} style={{ width: '40rem', height: '40rem' }} breakpoints={{ '960px': '75vw', '641px': '90vw' }} header={headerElement} footer={footerContent} modal className=" referral-popup p-fluid "  onHide={closepopup}>
              ...
              {/* Toggle switch between referral link and email invite */}
              ...
              {/* Referral link content place holder */}
